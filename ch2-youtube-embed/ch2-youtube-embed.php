...
// Function to add item to Settings menu and specify function to display options page content
                ...
                <?php for ( $counter = 1; $counter <= 5; $counter++ ) {
                    ...
                    <a class="nav-tab<?php echo $class; ?>" 
                        href="<?php echo add_query_arg( array( 'page' => 'ch2ye-youtube-embed', 'option_id' => $counter ), admin_url( 'options-general.php' ) ); ?>">
                            <?php  echo $counter; ?>
                            <?php if ( $temp_options !== false ) echo ' (' . $temp_options['setting_name'] . ')'; else echo ' (Empty)'; ?>
                    </a>
                <?php } ?>
